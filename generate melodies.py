# -*- coding: utf-8 -*-
"""
Created on Mon Jan 29 16:51:03 2024
...
SEQUENCE_LENGTH = 32
MAPPING_PATH = "mappingrock.json"  

class MelodyGenerator:
    """A class that wraps the LSTM model and offers utilities to generate melodies."""

    def __init__(self, model_path="modelrock.h5"):
    ...
    def save_melody(self, melody, step_duration=0.25, format="midi", file_name="rock1.mid"):
...
if __name__ == "__main__":
    mg = MelodyGenerator()
    seed = "62 _ 63 _ 67 _ _ _ 65"
    seed2 = "67 _ 69 _ 72 _ _ _ 71 _ 69 _ 71 _ 72 _ "
